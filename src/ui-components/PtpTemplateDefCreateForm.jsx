...
export default function PtpTemplateDefCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsTemplateUsed(initialValues.isTemplateUsed);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PtpTemplateDef(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PtpTemplateDefCreateForm")}
      {...rest}
    >
      <TextField
        label="Template name"
