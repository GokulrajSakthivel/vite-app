...
export default function ProjectSiteHierarchyCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setProjectSortKey(initialValues.projectSortKey);
    setEntityType(initialValues.entityType);
    setRegion(initialValues.region);
    setBusinessUnit(initialValues.businessUnit);
    setProjectSite(initialValues.projectSite);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ProjectSiteHierarchy(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProjectSiteHierarchyCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
