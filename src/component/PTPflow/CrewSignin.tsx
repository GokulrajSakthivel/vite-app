            ...
            <Card className="shadow-sm crew-card">
                <Card.Body>
                    ...
                    <Row className="align-items-center justify-content-between mb-3">
                        <Col>
                            <h6 className="mb-1 fw-semibold">Crew Sign in</h6>
                            ...
                            <tbody>
                                {currentMembers.map((m, index) => (
                                    <tr key={m.id}>
                                        ...
                                        <td className="signin-text"  onClick={() => { setShowModal(!showModal) }} ><span className="signCss"><img src={sign} alt="Sign in" width={20} height={20} /> <span >Sign in</span></span></td>
                                ...
                                {currentPage === totalPages && (
                                    <tr>
                                        ...
                                        <td className="signin-text"><span className="signCss"><img src={sign} alt="Sign in" width={20} height={20} /> <span>Sign in</span></span></td>
                                        {/* <td className="text-muted">--</td> */}
                                        <td>  
                                            <button
